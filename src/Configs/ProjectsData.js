...
const ProjectsData = [
  {
    title: "FoodVille",
    img: `${assets.foodville}`,
    description:
      "The FoodVille Web App is a UI project of a user-friendly online platform that allows users to browse, search, and order food from various restaurants",
    tech: "https://skillicons.dev/icons?i=react,js,css",
    github: "https://github.com/Upendhar10/FoodVille-WebApp",
